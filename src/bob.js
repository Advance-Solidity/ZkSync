...
//now implementing the Node.JS applications for the shopkeeper (Bob) and the customer (Alice) will be straightforward

/*
The shopkeeper - Wallets and private keys
*/
